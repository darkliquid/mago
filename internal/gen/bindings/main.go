...
var functions = []functionSpec{
	...
	{FieldName: "maNodeDetachOutputBus", Symbol: "ma_node_detach_output_bus", Type: "func(*nodeHandle, uint32) Result"},
	{FieldName: "maNodeDetachAllOutputBuses", Symbol: "ma_node_detach_all_output_buses", Type: "func(*nodeHandle) Result"},
	{FieldName: "maNodeSetOutputBusVolume", Symbol: "ma_node_set_output_bus_volume", Type: "func(*nodeHandle, uint32, float32) Result"},
	{FieldName: "maNodeGetOutputBusVolume", Symbol: "ma_node_get_output_bus_volume", Type: "func(*nodeHandle, uint32) float32"},
	{FieldName: "maNodeGetInputBusCount", Symbol: "ma_node_get_input_bus_count", Type: "func(*nodeHandle) uint32"},
	{FieldName: "maNodeGetOutputBusCount", Symbol: "ma_node_get_output_bus_count", Type: "func(*nodeHandle) uint32"},
	{FieldName: "maNodeGetInputChannels", Symbol: "ma_node_get_input_channels", Type: "func(*nodeHandle, uint32) uint32"},
	{FieldName: "maNodeGetOutputChannels", Symbol: "ma_node_get_output_channels", Type: "func(*nodeHandle, uint32) uint32"},
	{FieldName: "maNodeSetState", Symbol: "ma_node_set_state", Type: "func(*nodeHandle, NodeState) Result"},
	{FieldName: "maNodeGetState", Symbol: "ma_node_get_state", Type: "func(*nodeHandle) NodeState"},
	{FieldName: "maNodeSetStateTime", Symbol: "ma_node_set_state_time", Type: "func(*nodeHandle, NodeState, uint64) Result"},
	{FieldName: "maNodeGetStateTime", Symbol: "ma_node_get_state_time", Type: "func(*nodeHandle, NodeState) uint64"},
	{FieldName: "maNodeGetStateByTime", Symbol: "ma_node_get_state_by_time", Type: "func(*nodeHandle, uint64) NodeState"},
	{FieldName: "maNodeGetStateByTimeRange", Symbol: "ma_node_get_state_by_time_range", Type: "func(*nodeHandle, uint64, uint64) NodeState"},
	{FieldName: "maNodeGetTime", Symbol: "ma_node_get_time", Type: "func(*nodeHandle) uint64"},
	{FieldName: "maNodeSetTime", Symbol: "ma_node_set_time", Type: "func(*nodeHandle, uint64) Result"},
	{FieldName: "maDataSourceNodeInit", Symbol: "ma_data_source_node_init", Type: "func(*nodeGraphHandle, *dataSourceNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maDataSourceNodeUninit", Symbol: "ma_data_source_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maDataSourceNodeSetLooping", Symbol: "ma_data_source_node_set_looping", Type: "func(*nodeHandle, uint32) Result"},
	{FieldName: "maDataSourceNodeIsLooping", Symbol: "ma_data_source_node_is_looping", Type: "func(*nodeHandle) uint32"},
	{FieldName: "maSplitterNodeInit", Symbol: "ma_splitter_node_init", Type: "func(*nodeGraphHandle, *splitterNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maSplitterNodeUninit", Symbol: "ma_splitter_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maBiquadNodeInit", Symbol: "ma_biquad_node_init", Type: "func(*nodeGraphHandle, *biquadNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maBiquadNodeReinit", Symbol: "ma_biquad_node_reinit", Type: "func(*biquadConfigNative, *nodeHandle) Result"},
	{FieldName: "maBiquadNodeUninit", Symbol: "ma_biquad_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maLPFNodeInit", Symbol: "ma_lpf_node_init", Type: "func(*nodeGraphHandle, *lpfNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maLPFNodeReinit", Symbol: "ma_lpf_node_reinit", Type: "func(*lpfConfigNative, *nodeHandle) Result"},
	{FieldName: "maLPFNodeUninit", Symbol: "ma_lpf_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maHPFNodeInit", Symbol: "ma_hpf_node_init", Type: "func(*nodeGraphHandle, *hpfNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maHPFNodeReinit", Symbol: "ma_hpf_node_reinit", Type: "func(*hpfConfigNative, *nodeHandle) Result"},
	{FieldName: "maHPFNodeUninit", Symbol: "ma_hpf_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maBPFNodeInit", Symbol: "ma_bpf_node_init", Type: "func(*nodeGraphHandle, *bpfNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maBPFNodeReinit", Symbol: "ma_bpf_node_reinit", Type: "func(*bpfConfigNative, *nodeHandle) Result"},
	{FieldName: "maBPFNodeUninit", Symbol: "ma_bpf_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maNotchNodeInit", Symbol: "ma_notch_node_init", Type: "func(*nodeGraphHandle, *notchNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maNotchNodeReinit", Symbol: "ma_notch_node_reinit", Type: "func(*notch2ConfigNative, *nodeHandle) Result"},
	{FieldName: "maNotchNodeUninit", Symbol: "ma_notch_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maPeakNodeInit", Symbol: "ma_peak_node_init", Type: "func(*nodeGraphHandle, *peakNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maPeakNodeReinit", Symbol: "ma_peak_node_reinit", Type: "func(*peak2ConfigNative, *nodeHandle) Result"},
	{FieldName: "maPeakNodeUninit", Symbol: "ma_peak_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maLoShelfNodeInit", Symbol: "ma_loshelf_node_init", Type: "func(*nodeGraphHandle, *loshelfNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maLoShelfNodeReinit", Symbol: "ma_loshelf_node_reinit", Type: "func(*loshelf2ConfigNative, *nodeHandle) Result"},
	{FieldName: "maLoShelfNodeUninit", Symbol: "ma_loshelf_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maHiShelfNodeInit", Symbol: "ma_hishelf_node_init", Type: "func(*nodeGraphHandle, *hishelfNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maHiShelfNodeReinit", Symbol: "ma_hishelf_node_reinit", Type: "func(*hishelf2ConfigNative, *nodeHandle) Result"},
	{FieldName: "maHiShelfNodeUninit", Symbol: "ma_hishelf_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maDelayNodeInit", Symbol: "ma_delay_node_init", Type: "func(*nodeGraphHandle, *delayNodeConfigNative, unsafe.Pointer, *nodeHandle) Result"},
	{FieldName: "maDelayNodeUninit", Symbol: "ma_delay_node_uninit", Type: "func(*nodeHandle, unsafe.Pointer)"},
	{FieldName: "maDelayNodeSetWet", Symbol: "ma_delay_node_set_wet", Type: "func(*nodeHandle, float32)"},
	{FieldName: "maDelayNodeGetWet", Symbol: "ma_delay_node_get_wet", Type: "func(*nodeHandle) float32"},
	{FieldName: "maDelayNodeSetDry", Symbol: "ma_delay_node_set_dry", Type: "func(*nodeHandle, float32)"},
	{FieldName: "maDelayNodeGetDry", Symbol: "ma_delay_node_get_dry", Type: "func(*nodeHandle) float32"},
	{FieldName: "maDelayNodeSetDecay", Symbol: "ma_delay_node_set_decay", Type: "func(*nodeHandle, float32)"},
	{FieldName: "maDelayNodeGetDecay", Symbol: "ma_delay_node_get_decay", Type: "func(*nodeHandle) float32"},
	{FieldName: "maEngineInit", Symbol: "ma_engine_init", Type: "func(*engineConfigNative, *engineHandle) Result"},
	{FieldName: "maEngineUninit", Symbol: "ma_engine_uninit", Type: "func(*engineHandle)"},
	{FieldName: "maEngineReadPCMFrames", Symbol: "ma_engine_read_pcm_frames", Type: "func(*engineHandle, unsafe.Pointer, uint64, *uint64) Result"},
	{FieldName: "maEngineGetNodeGraph", Symbol: "ma_engine_get_node_graph", Type: "func(*engineHandle) *nodeGraphHandle"},
	{FieldName: "maEngineGetEndpoint", Symbol: "ma_engine_get_endpoint", Type: "func(*engineHandle) *nodeHandle"},
	{FieldName: "maEngineGetTimeInPCMFrames", Symbol: "ma_engine_get_time_in_pcm_frames", Type: "func(*engineHandle) uint64"},
	{FieldName: "maEngineSetTimeInPCMFrames", Symbol: "ma_engine_set_time_in_pcm_frames", Type: "func(*engineHandle, uint64) Result"},
	{FieldName: "maEngineGetChannels", Symbol: "ma_engine_get_channels", Type: "func(*engineHandle) uint32"},
	{FieldName: "maEngineGetSampleRate", Symbol: "ma_engine_get_sample_rate", Type: "func(*engineHandle) uint32"},
	{FieldName: "maEngineStart", Symbol: "ma_engine_start", Type: "func(*engineHandle) Result"},
	{FieldName: "maEngineStop", Symbol: "ma_engine_stop", Type: "func(*engineHandle) Result"},
	{FieldName: "maEngineSetVolume", Symbol: "ma_engine_set_volume", Type: "func(*engineHandle, float32) Result"},
	{FieldName: "maEngineGetVolume", Symbol: "ma_engine_get_volume", Type: "func(*engineHandle) float32"},
	{FieldName: "maEngineSetGainDB", Symbol: "ma_engine_set_gain_db", Type: "func(*engineHandle, float32) Result"},
	{FieldName: "maEngineGetGainDB", Symbol: "ma_engine_get_gain_db", Type: "func(*engineHandle) float32"},
	{FieldName: "maEngineGetListenerCount", Symbol: "ma_engine_get_listener_count", Type: "func(*engineHandle) uint32"},
	{FieldName: "maEngineFindClosestListener", Symbol: "ma_engine_find_closest_listener", Type: "func(*engineHandle, float32, float32, float32) uint32"},
	{FieldName: "maEngineListenerSetPosition", Symbol: "ma_engine_listener_set_position", Type: "func(*engineHandle, uint32, float32, float32, float32)"},
	{FieldName: "maEngineListenerSetDirection", Symbol: "ma_engine_listener_set_direction", Type: "func(*engineHandle, uint32, float32, float32, float32)"},
	{FieldName: "maEngineListenerSetVelocity", Symbol: "ma_engine_listener_set_velocity", Type: "func(*engineHandle, uint32, float32, float32, float32)"},
	{FieldName: "maEngineListenerSetCone", Symbol: "ma_engine_listener_set_cone", Type: "func(*engineHandle, uint32, float32, float32, float32)"},
	{FieldName: "maEngineListenerGetCone", Symbol: "ma_engine_listener_get_cone", Type: "func(*engineHandle, uint32, *float32, *float32, *float32)"},
	{FieldName: "maEngineListenerSetWorldUp", Symbol: "ma_engine_listener_set_world_up", Type: "func(*engineHandle, uint32, float32, float32, float32)"},
	{FieldName: "maEngineListenerSetEnabled", Symbol: "ma_engine_listener_set_enabled", Type: "func(*engineHandle, uint32, uint32)"},
	{FieldName: "maEngineListenerIsEnabled", Symbol: "ma_engine_listener_is_enabled", Type: "func(*engineHandle, uint32) uint32"},
	{FieldName: "maEnginePlaySoundEx", Symbol: "ma_engine_play_sound_ex", Type: "func(*engineHandle, string, *nodeHandle, uint32) Result"},
	{FieldName: "maEnginePlaySound", Symbol: "ma_engine_play_sound", Type: "func(*engineHandle, string, *soundHandle) Result"},
	{FieldName: "magoEngineListenerGetPosition", Symbol: "mago_engine_listener_get_position", Type: "func(*engineHandle, uint32, *float32)"},
	{FieldName: "magoEngineListenerGetDirection", Symbol: "mago_engine_listener_get_direction", Type: "func(*engineHandle, uint32, *float32)"},
	{FieldName: "magoEngineListenerGetVelocity", Symbol: "mago_engine_listener_get_velocity", Type: "func(*engineHandle, uint32, *float32)"},
	{FieldName: "magoEngineListenerGetWorldUp", Symbol: "mago_engine_listener_get_world_up", Type: "func(*engineHandle, uint32, *float32)"},
	{FieldName: "maSoundInitFromFile", Symbol: "ma_sound_init_from_file", Type: "func(*engineHandle, string, uint32, *soundHandle, unsafe.Pointer, *soundHandle) Result"},
	{FieldName: "maSoundInitFromDataSource", Symbol: "ma_sound_init_from_data_source", Type: "func(*engineHandle, *dataSourceHandle, uint32, *soundHandle, *soundHandle) Result"},
	{FieldName: "maSoundInitCopy", Symbol: "ma_sound_init_copy", Type: "func(*engineHandle, *soundHandle, uint32, *soundHandle, *soundHandle) Result"},
	{FieldName: "maSoundGroupInit", Symbol: "ma_sound_group_init", Type: "func(*engineHandle, uint32, *soundHandle, *soundHandle) Result"},
	{FieldName: "maSoundUninit", Symbol: "ma_sound_uninit", Type: "func(*soundHandle)"},
	{FieldName: "maSoundStart", Symbol: "ma_sound_start", Type: "func(*soundHandle) Result"},
	{FieldName: "maSoundStop", Symbol: "ma_sound_stop", Type: "func(*soundHandle) Result"},
	{FieldName: "maSoundStopWithFadeInPCMFrames", Symbol: "ma_sound_stop_with_fade_in_pcm_frames", Type: "func(*soundHandle, uint64) Result"},
	{FieldName: "maSoundResetStartTime", Symbol: "ma_sound_reset_start_time", Type: "func(*soundHandle)"},
	{FieldName: "maSoundResetStopTime", Symbol: "ma_sound_reset_stop_time", Type: "func(*soundHandle)"},
	{FieldName: "maSoundResetFade", Symbol: "ma_sound_reset_fade", Type: "func(*soundHandle)"},
	{FieldName: "maSoundResetStopTimeAndFade", Symbol: "ma_sound_reset_stop_time_and_fade", Type: "func(*soundHandle)"},
	{FieldName: "maSoundSetVolume", Symbol: "ma_sound_set_volume", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetVolume", Symbol: "ma_sound_get_volume", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetPan", Symbol: "ma_sound_set_pan", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetPan", Symbol: "ma_sound_get_pan", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetPanMode", Symbol: "ma_sound_set_pan_mode", Type: "func(*soundHandle, PanMode)"},
	{FieldName: "maSoundGetPanMode", Symbol: "ma_sound_get_pan_mode", Type: "func(*soundHandle) PanMode"},
	{FieldName: "maSoundSetPitch", Symbol: "ma_sound_set_pitch", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetPitch", Symbol: "ma_sound_get_pitch", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetSpatializationEnabled", Symbol: "ma_sound_set_spatialization_enabled", Type: "func(*soundHandle, uint32)"},
	{FieldName: "maSoundIsSpatializationEnabled", Symbol: "ma_sound_is_spatialization_enabled", Type: "func(*soundHandle) uint32"},
	{FieldName: "maSoundSetPinnedListenerIndex", Symbol: "ma_sound_set_pinned_listener_index", Type: "func(*soundHandle, uint32)"},
	{FieldName: "maSoundGetPinnedListenerIndex", Symbol: "ma_sound_get_pinned_listener_index", Type: "func(*soundHandle) uint32"},
	{FieldName: "maSoundGetListenerIndex", Symbol: "ma_sound_get_listener_index", Type: "func(*soundHandle) uint32"},
	{FieldName: "magoSoundGetDirectionToListener", Symbol: "mago_sound_get_direction_to_listener", Type: "func(*soundHandle, *float32)"},
	{FieldName: "maSoundSetPosition", Symbol: "ma_sound_set_position", Type: "func(*soundHandle, float32, float32, float32)"},
	{FieldName: "magoSoundGetPosition", Symbol: "mago_sound_get_position", Type: "func(*soundHandle, *float32)"},
	{FieldName: "maSoundSetDirection", Symbol: "ma_sound_set_direction", Type: "func(*soundHandle, float32, float32, float32)"},
	{FieldName: "magoSoundGetDirection", Symbol: "mago_sound_get_direction", Type: "func(*soundHandle, *float32)"},
	{FieldName: "maSoundSetVelocity", Symbol: "ma_sound_set_velocity", Type: "func(*soundHandle, float32, float32, float32)"},
	{FieldName: "magoSoundGetVelocity", Symbol: "mago_sound_get_velocity", Type: "func(*soundHandle, *float32)"},
	{FieldName: "maSoundSetAttenuationModel", Symbol: "ma_sound_set_attenuation_model", Type: "func(*soundHandle, AttenuationModel)"},
	{FieldName: "maSoundGetAttenuationModel", Symbol: "ma_sound_get_attenuation_model", Type: "func(*soundHandle) AttenuationModel"},
	{FieldName: "maSoundSetPositioning", Symbol: "ma_sound_set_positioning", Type: "func(*soundHandle, Positioning)"},
	{FieldName: "maSoundGetPositioning", Symbol: "ma_sound_get_positioning", Type: "func(*soundHandle) Positioning"},
	{FieldName: "maSoundSetRolloff", Symbol: "ma_sound_set_rolloff", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetRolloff", Symbol: "ma_sound_get_rolloff", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetMinGain", Symbol: "ma_sound_set_min_gain", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetMinGain", Symbol: "ma_sound_get_min_gain", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetMaxGain", Symbol: "ma_sound_set_max_gain", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetMaxGain", Symbol: "ma_sound_get_max_gain", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetMinDistance", Symbol: "ma_sound_set_min_distance", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetMinDistance", Symbol: "ma_sound_get_min_distance", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetMaxDistance", Symbol: "ma_sound_set_max_distance", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetMaxDistance", Symbol: "ma_sound_get_max_distance", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetCone", Symbol: "ma_sound_set_cone", Type: "func(*soundHandle, float32, float32, float32)"},
	{FieldName: "maSoundGetCone", Symbol: "ma_sound_get_cone", Type: "func(*soundHandle, *float32, *float32, *float32)"},
	{FieldName: "maSoundSetDopplerFactor", Symbol: "ma_sound_set_doppler_factor", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetDopplerFactor", Symbol: "ma_sound_get_doppler_factor", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetDirectionalAttenuationFactor", Symbol: "ma_sound_set_directional_attenuation_factor", Type: "func(*soundHandle, float32)"},
	{FieldName: "maSoundGetDirectionalAttenuationFactor", Symbol: "ma_sound_get_directional_attenuation_factor", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetFadeInPCMFrames", Symbol: "ma_sound_set_fade_in_pcm_frames", Type: "func(*soundHandle, float32, float32, uint64)"},
	{FieldName: "maSoundSetFadeStartInPCMFrames", Symbol: "ma_sound_set_fade_start_in_pcm_frames", Type: "func(*soundHandle, float32, float32, uint64, uint64)"},
	{FieldName: "maSoundGetCurrentFadeVolume", Symbol: "ma_sound_get_current_fade_volume", Type: "func(*soundHandle) float32"},
	{FieldName: "maSoundSetStartTimeInPCMFrames", Symbol: "ma_sound_set_start_time_in_pcm_frames", Type: "func(*soundHandle, uint64)"},
	{FieldName: "maSoundSetStopTimeInPCMFrames", Symbol: "ma_sound_set_stop_time_in_pcm_frames", Type: "func(*soundHandle, uint64)"},
	{FieldName: "maSoundSetStopTimeWithFadeInPCMFrames", Symbol: "ma_sound_set_stop_time_with_fade_in_pcm_frames", Type: "func(*soundHandle, uint64, uint64)"},
	{FieldName: "maSoundIsPlaying", Symbol: "ma_sound_is_playing", Type: "func(*soundHandle) uint32"},
	{FieldName: "maSoundGetTimeInPCMFrames", Symbol: "ma_sound_get_time_in_pcm_frames", Type: "func(*soundHandle) uint64"},
	{FieldName: "maSoundSetLooping", Symbol: "ma_sound_set_looping", Type: "func(*soundHandle, uint32)"},
	{FieldName: "maSoundIsLooping", Symbol: "ma_sound_is_looping", Type: "func(*soundHandle) uint32"},
	{FieldName: "maSoundAtEnd", Symbol: "ma_sound_at_end", Type: "func(*soundHandle) uint32"},
	{FieldName: "maSoundSeekToPCMFrame", Symbol: "ma_sound_seek_to_pcm_frame", Type: "func(*soundHandle, uint64) Result"},
	{FieldName: "maSoundGetDataFormat", Symbol: "ma_sound_get_data_format", Type: "func(*soundHandle, *Format, *uint32, *uint32, *uint8, uintptr) Result"},
	{FieldName: "maSoundGetCursorInPCMFrames", Symbol: "ma_sound_get_cursor_in_pcm_frames", Type: "func(*soundHandle, *uint64) Result"},
	{FieldName: "maSoundGetLengthInPCMFrames", Symbol: "ma_sound_get_length_in_pcm_frames", Type: "func(*soundHandle, *uint64) Result"},
	{FieldName: "maSoundSetEndCallback", Symbol: "ma_sound_set_end_callback", Type: "func(*soundHandle, uintptr, uintptr) Result"},
}
